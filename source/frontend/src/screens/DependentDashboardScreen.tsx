...
export default function DependentDashboardScreen({ route, navigation }: Props) {
  ...
  const { medications, deleteMedication } = useAuth();

  const rotinaDependente = medications.filter(med => med.dependenteId === dependenteId);
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <CustomButton 
        ...
        onPress={() => navigation.navigate('Search', { dependenteId })}
        ...
        renderItem={({ item }) => (
          <View style={styles.medCard}>
            ...
            <View style={styles.actionButtons}>
              <TouchableOpacity style={styles.editBtn} onPress={() => navigation.navigate('Search', { dependenteId, medicamento: item })}>
